    ...
    <>
      ...
      <main className={styles.bodyExpedition}>
        <div className={styles.contenuExpedition}>
          ...
          <p className={styles.contenuExpedition}>
            Les clients peuvent engager une procédure de retour dans les 7 jours à compter de la date de réception.
            Si le client souhaite retourner ses achats, il est en droit de le faire sans nécessairement apporter de
            justification. Le site marchand ne peut le refuser.
          </p>
        </div>
      </main>
      <Footer />
